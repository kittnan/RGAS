...
@Component({
  selector: 'app-engineer-rgas2',
  templateUrl: './engineer-rgas2.component.html',
  styleUrls: ['./engineer-rgas2.component.scss']
})
export class EngineerRgas2Component implements OnInit {
