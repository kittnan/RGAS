...
@Component({
  selector: 'app-rgas1-ant-virtual-table',
  templateUrl: './rgas1-ant-virtual-table.component.html',
  styleUrls: ['./rgas1-ant-virtual-table.component.scss']
})
export class Rgas1AntVirtualTableComponent implements OnInit {
